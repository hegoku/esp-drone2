...
void angle_q_pid_compute(struct angle_q_pid_param *p)
{
	...
	if (p->q_error_b.q0<0) {
		p->q_error_b.q0 = -p->q_error_b.q0;
		p->q_error_b.q1 = -p->q_error_b.q1;
		p->q_error_b.q2 = -p->q_error_b.q2;
		p->q_error_b.q3 = -p->q_error_b.q3;
	}

	float s = invSqrt(p->q_error_b.q1*p->q_error_b.q1 + p->q_error_b.q2*p->q_error_b.q2 + p->q_error_b.q3*p->q_error_b.q3);
	...
	// } else {
		float theta = 2.0f * atan2f(1.0f/s, p->q_error_b.q0);

...
#define ANOTC_FRAME_DATA_ANALYSIS_LIST_CMD 0xEF
...
#define ANOTC_CONFIG_DATA_ANALYSIS_LIST_COUNT 0x00
#define ANOTC_CONFIG_DATA_ANALYSIS_LIST_ITEM_INFO 0x01
#define ANOTC_CONFIG_DATA_ANALYSIS_LIST_SET 0x02
